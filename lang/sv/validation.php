...
return [
    ...
    */
    ...
    'lte' => [
        ...
        'file' => 'Fältet :attribute måste vara högst :value kilobyte.',
        'numeric' => 'Fältet :attribute måste vara högst :value.',
        'string' => 'Fältet :attribute måste vara högst :value tecken.',
    ],
    ...
    'missing' => 'Fältet :attribute får inte finnas.',
    'missing_if' => 'Fältet :attribute får inte finnas när :other är :value.',
    'missing_unless' => 'Fältet :attribute får inte finnas om inte :other är :value.',
    'missing_with' => 'Fältet :attribute får inte finnas när :values finns.',
    'missing_with_all' => 'Fältet :attribute får inte finnas när :values finns.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Det angivna värdet för :attribute har förekommit i en dataläcka. Välj ett annat :attribute.',
    ],
    ...
    'required_if_declined' => 'Fältet :attribute är obligatoriskt när :other är avböjt.',
    ...
    'unique' => 'Värdet för :attribute är redan taget.',
