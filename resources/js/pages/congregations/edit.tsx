...
import { edit, update } from '@/routes/congregation';
...
type Props = {
    team: Congregation & { slug: string; congregation_number: string | null };
...
CongregationEdit.layout = (props: {
    team: { name: string; slug: string; congregation_number: string | null };
}) => ({
    breadcrumbs: [
        {
            title: 'Congregations',
