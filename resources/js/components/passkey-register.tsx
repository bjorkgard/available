    ...
    if (!isSupported) {
        return (
            <div className="text-sm text-muted-foreground">
                {t('Passnycklar stöds inte i denna webbläsare.')}
            </div>
        );
    }
    ...
    return (
        ...
        >
            <div className="grid gap-2">
                <Label htmlFor="passkey-name">{t('Passnyckelnamn')}</Label>
                <Input
                    id="passkey-name"
                    type="text"
                    value={name}
                    onChange={(e) => setName(e.target.value)}
                    placeholder={t('t.ex. MacBook Pro, iPhone')}
